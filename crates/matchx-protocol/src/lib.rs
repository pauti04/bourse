//! matchx wire protocol — binary codec, no I/O.
//!
...
//! drove the WAL codec — see `matchx_core::wal`.

use matchx_core::matcher::{DoneReason, Event, NewOrder, OrderKind};
use matchx_core::types::{OrderId, Price, Qty, Sequence, Side, Timestamp};
